...
ui <- fluidPage(
  pageWithSidebar(
    ...
    mainPanel(
      ...
      h4("Instruction"),
      h5("Use the sliders to adjust the values of wine's physicochemical properties to calcualate the wine's quality score. Higher score means objectively better wine."),
      h4("Github"),
