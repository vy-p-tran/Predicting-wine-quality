...
ui <- fluidPage(
  pageWithSidebar(
    ...
    mainPanel(
      ...
      h2("Age appears best in four things: old wood to burn, old wine to drink, old friends to trust and old authors to read. - Francis Bacon - "),
      h4("Overview"),
      ...
      h4("The predicted quality score for this wine is:"),
      h4(textOutput("value")),
      h4("Github"),
      h5("")
      h6("Data source: Paulo Cortez, University of Minho, Guimaraes, Portugal, http://www3.dsi.uminho.pt/pcortez")
